...
#define B_SKETCH_BANS               GEN_2 // In Gen9+, Sketch is unable to copy more moves than in previous generations.
...
#define B_ALL_BATTLES_DYNAMAX       TRUE  // If set, all battles are Dynamax battles.
...
#define B_OBEDIENCE_MECHANICS           GEN_2 // In PLA+ (here Gen8+), obedience restrictions also apply to non-outsider Pokémon, albeit based on their level met rather than actual level
