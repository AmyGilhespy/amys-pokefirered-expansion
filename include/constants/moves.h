...
#define MOVE_HELLFIRE (MOVES_PREAMY_COUNT + 112)
#define MOVE_ABSOLUTE_ZERO (MOVES_PREAMY_COUNT + 113)
#define MOVE_RAILGUN (MOVES_PREAMY_COUNT + 114)
#define MOVE_MEGA_BONE (MOVES_PREAMY_COUNT + 115)
#define MOVE_ZENITH_BLAST (MOVES_PREAMY_COUNT + 116)

#define MOVES_COUNT_AMY (MOVE_ZENITH_BLAST + 1)
