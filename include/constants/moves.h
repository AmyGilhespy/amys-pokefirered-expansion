...
#define MOVE_SUBSTITUTE_S (MOVES_PREAMY_COUNT + 101)
#define MOVE_SUBSTITUTE_L (MOVES_PREAMY_COUNT + 102)
#define MOVE_SUBSTITUTE_XL (MOVES_PREAMY_COUNT + 103)
...
#define MOVE_MEGA_LICK (MOVES_PREAMY_COUNT + 115)
#define MOVE_PHOENIX_CALL (MOVES_PREAMY_COUNT + 116)

#define MOVES_COUNT_AMY (MOVE_PHOENIX_CALL + 1)
