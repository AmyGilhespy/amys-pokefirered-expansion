...
#define MOVE_HELLFIRE (MOVES_PREAMY_COUNT + 110) // 958
#define MOVE_ABSOLUTE_ZERO (MOVES_PREAMY_COUNT + 111) // 959
#define MOVE_RAILGUN (MOVES_PREAMY_COUNT + 112) // 960
#define MOVE_MEGA_LICK (MOVES_PREAMY_COUNT + 113) // 961
#define MOVE_PHOENIX_CALL (MOVES_PREAMY_COUNT + 114) // 962
#define MOVE_MAIL_SCRIPT (MOVES_PREAMY_COUNT + 115) // 963
#define MOVE_MAIL_CALL (MOVES_PREAMY_COUNT + 116) // 964

#define MOVES_COUNT_AMY (MOVE_MAIL_CALL + 1) // 965
