...
#define MOVE_SMALL_SUBSTITUTE (MOVES_PREAMY_COUNT + 101)
#define MOVE_BIG_SUBSTITUTE (MOVES_PREAMY_COUNT + 102)
#define MOVE_HUGE_SUBSTITUTE (MOVES_PREAMY_COUNT + 103)
#define MOVE_OMEGA_BEAM (MOVES_PREAMY_COUNT + 104)
#define MOVE_OMEGA_STRIKE (MOVES_PREAMY_COUNT + 105)
#define MOVE_OBLIVION_BEAM (MOVES_PREAMY_COUNT + 106)
#define MOVE_ULTIMA_STRIKE (MOVES_PREAMY_COUNT + 107)
#define MOVE_INFINIBLAST (MOVES_PREAMY_COUNT + 108)
#define MOVE_SINGULARITY_X (MOVES_PREAMY_COUNT + 109)
#define MOVE_SINGULARITY_Y (MOVES_PREAMY_COUNT + 110)
#define MOVE_SINGULARITY_Z (MOVES_PREAMY_COUNT + 111)
