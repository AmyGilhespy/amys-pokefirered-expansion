...
#define MOVE_SUBSTITUTE_S (MOVES_PREAMY_COUNT + 101) // 949
#define MOVE_SUBSTITUTE_L (MOVES_PREAMY_COUNT + 102) // 950
#define MOVE_SUBSTITUTE_XL (MOVES_PREAMY_COUNT + 103) // 951
#define MOVE_OMEGA_BEAM (MOVES_PREAMY_COUNT + 104) // 952
#define MOVE_OMEGA_STRIKE (MOVES_PREAMY_COUNT + 105) // 953
#define MOVE_OBLIVION_BEAM (MOVES_PREAMY_COUNT + 106) // 954
#define MOVE_ULTIMA_STRIKE (MOVES_PREAMY_COUNT + 107) // 955
#define MOVE_INFINIBLAST (MOVES_PREAMY_COUNT + 108) // 956
#define MOVE_SINGULARITY_X (MOVES_PREAMY_COUNT + 109) // 957
#define MOVE_SINGULARITY_Y (MOVES_PREAMY_COUNT + 110) // 958
#define MOVE_SINGULARITY_Z (MOVES_PREAMY_COUNT + 111) // 959
#define MOVE_HELLFIRE (MOVES_PREAMY_COUNT + 112) // 960
#define MOVE_ABSOLUTE_ZERO (MOVES_PREAMY_COUNT + 113) // 961
#define MOVE_RAILGUN (MOVES_PREAMY_COUNT + 114) // 962
#define MOVE_MEGA_LICK (MOVES_PREAMY_COUNT + 115) // 963
#define MOVE_PHOENIX_CALL (MOVES_PREAMY_COUNT + 116) // 964
#define MOVE_MAIL_SCRIPT (MOVES_PREAMY_COUNT + 117) // 965
#define MOVE_MAIL_CALL (MOVES_PREAMY_COUNT + 118) // 966

#define MOVES_COUNT_AMY (MOVE_MAIL_CALL + 1) // 967

#define MOVES_COUNT         MOVES_COUNT_AMY
