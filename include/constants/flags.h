...
#define FLAG_ESCAPE_ROOM_GOT_ITEMS_FROM_PROSTITUTE 0x4F1
#define FLAG_ESCAPE_ROOM_CAUGHT_BIDOOF 0x4F2
#define FLAG_ESCAPE_ROOM_GOT_ITEMS_FROM_SITTING_BOY 0x4F3
#define FLAG_ESCAPE_ROOM_HIDE_SITTING_BOY 0x4F4
