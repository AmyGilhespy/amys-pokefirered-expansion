...
#define ITEM_LIGMA_BALL 24
#define ITEM_ROCKET_BALL 25
...
#define UPSTREAM_ITEMS_COUNT 829
...
#define ITEM_PISS                 (UPSTREAM_ITEMS_COUNT +  6)
#define ITEM_MIDDLE_STONE         (UPSTREAM_ITEMS_COUNT +  7)
#define ITEM_IV_UP_HP             (UPSTREAM_ITEMS_COUNT +  8)
#define ITEM_IV_UP_ATK            (UPSTREAM_ITEMS_COUNT +  9)
#define ITEM_IV_UP_DEF            (UPSTREAM_ITEMS_COUNT + 10)
#define ITEM_IV_UP_SPATK          (UPSTREAM_ITEMS_COUNT + 11)
#define ITEM_IV_UP_SPDEF          (UPSTREAM_ITEMS_COUNT + 12)
#define ITEM_IV_UP_SPEED          (UPSTREAM_ITEMS_COUNT + 13)
#define ITEM_IV_DOWN_HP           (UPSTREAM_ITEMS_COUNT + 14)
#define ITEM_IV_DOWN_ATK          (UPSTREAM_ITEMS_COUNT + 15)
#define ITEM_IV_DOWN_DEF          (UPSTREAM_ITEMS_COUNT + 16)
#define ITEM_IV_DOWN_SPATK        (UPSTREAM_ITEMS_COUNT + 17)
#define ITEM_IV_DOWN_SPDEF        (UPSTREAM_ITEMS_COUNT + 18)
#define ITEM_IV_DOWN_SPEED        (UPSTREAM_ITEMS_COUNT + 19)
#define ITEM_FRIENDSHIP_UP        (UPSTREAM_ITEMS_COUNT + 20)
#define ITEM_FRIENDSHIP_DOWN      (UPSTREAM_ITEMS_COUNT + 21)
#define ITEM_BLANK_PLATE          (UPSTREAM_ITEMS_COUNT + 22)
#define ITEMS_COUNT (ITEM_BLANK_PLATE + 1)
