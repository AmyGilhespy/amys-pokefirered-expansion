...
extern const u8 BattleScript_FaintAttackerFainted[];
...
extern const u8 BattleScript_ItemDrizzleActivates[];
...
extern const u8 BattleScript_ItemDroughtActivates[];
...
extern const u8 BattleScript_SelectingNotAllowedMoveBindingRope[];
...
extern const u8 BattleScript_ItemPerishActivates[];
...
extern const u8 BattleScript_ItemBlockedByPrimalWeatherEnd3[];
...
extern const u8 BattleScript_AlreadyFrozen[];
...
extern const u8 BattleScript_EffectResurrection[];
extern const u8 BattleScript_EffectMailScript[];
extern const u8 BattleScript_EffectMailCall[];
extern const u8 BattleScript_EffectVerdance[];
