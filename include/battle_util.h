...
void CopyMonAbilityAndTypesToBattleMon(u32 battler, struct Pokemon *mon, u16 species);
void RecalcBattlerStats(u32 battler, struct Pokemon *mon, bool32 isDynamaxing, u16 species);
