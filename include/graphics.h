...
extern const u32 gBallGfx_Ligma[];
extern const u16 gBallPal_Ligma[];
extern const u32 gBallGfx_Rocket[];
extern const u16 gBallPal_Rocket[];
...
extern const u16 gMonPalette_Dugtrio[];
extern const u32 gMonBackPic_Dugtrio[];
extern const u16 gMonShinyPalette_Dugtrio[];
...
extern const u16 gTrainerPalette_RSAromaLady[];
extern const u16 gTrainerPalette_RSRuinManiac[];
extern const u16 gTrainerPalette_Interviewer[];
extern const u16 gTrainerPalette_RSTuberF[];
extern const u16 gTrainerPalette_TuberM[];
extern const u16 gTrainerPalette_RSCooltrainerM[];
extern const u16 gTrainerPalette_RSCooltrainerF[];
extern const u16 gTrainerPalette_HexManiac[];
extern const u16 gTrainerPalette_RSLady[];
extern const u16 gTrainerPalette_RSBeauty[];
extern const u16 gTrainerPalette_RichBoy[];
extern const u16 gTrainerPalette_RSPokeManiac[];
extern const u16 gTrainerPalette_RSSwimmerM[];
extern const u16 gTrainerPalette_RSBlackBelt[];
extern const u16 gTrainerPalette_Guitarist[];
extern const u16 gTrainerPalette_Kindler[];
extern const u16 gTrainerPalette_RSCamper[];
extern const u16 gTrainerPalette_BugManiac[];
extern const u16 gTrainerPalette_RSPsychicM[];
extern const u16 gTrainerPalette_RSPsychicF[];
extern const u16 gTrainerPalette_RSGentleman[];
...
extern const u16 gTrainerPalette_RSYoungster[];
extern const u16 gTrainerPalette_ChampionSteven[];
extern const u16 gTrainerPalette_RSFisherman[];
...
extern const u16 gTrainerPalette_RSBirdKeeper[];
...
extern const u16 gTrainerPalette_RSSwimmerF[];
extern const u16 gTrainerPalette_RSPicnicker[];
extern const u16 gTrainerPalette_RSTwins[];
extern const u16 gTrainerPalette_RSSailor[];
extern const u16 gTrainerPalette_Collector[];
extern const u16 gTrainerPalette_Wally[];
extern const u16 gTrainerPalette_RSBrendan1[];
extern const u16 gTrainerPalette_RSMay1[];
extern const u16 gTrainerPalette_LeafBackPic[];
extern const u16 gTrainerPalette_RedBackPic[];
extern const u16 gTrainerPalette_PokedudeBackPic[];
extern const u16 gTrainerPalette_OldManBackPic[];
extern const u16 gTrainerPalette_Steven[];
extern const u16 gTrainerPalette_RSPokemonBreederM[];
extern const u16 gTrainerPalette_RSPokemonBreederF[];
extern const u16 gTrainerPalette_RSPokemonRangerM[];
extern const u16 gTrainerPalette_RSPokemonRangerF[];
...
extern const u16 gTrainerPalette_RSLass[];
extern const u16 gTrainerPalette_RSBugCatcher[];
extern const u16 gTrainerPalette_RSHiker[];
extern const u16 gTrainerPalette_RSYoungCouple[];
extern const u16 gTrainerPalette_OldCouple[];
extern const u16 gTrainerPalette_RSSisAndBro[];
extern const u16 gTrainerPalette_AquaAdminM[];
extern const u16 gTrainerPalette_AquaAdminF[];
extern const u16 gTrainerPalette_MagmaAdminM[];
extern const u16 gTrainerPalette_MagmaAdminF[];
...
extern const u16 gTrainerPalette_LeaderWallace[];
...
extern const u16 gTrainerPalette_SuperNerd[];
extern const u16 gTrainerPalette_Hiker[];
extern const u16 gTrainerPalette_Biker[];
extern const u16 gTrainerPalette_Burglar[];
extern const u16 gTrainerPalette_Engineer[];
extern const u16 gTrainerPalette_Fisherman[];
extern const u16 gTrainerPalette_SwimmerM[];
extern const u16 gTrainerPalette_CueBall[];
extern const u16 gTrainerPalette_Gamer[];
...
extern const u16 gTrainerPalette_Rocker[];
...
extern const u16 gTrainerPalette_RivalEarly[];
extern const u16 gTrainerPalette_Scientist[];
extern const u16 gTrainerPalette_LeaderGiovanni[];
extern const u16 gTrainerPalette_RocketGruntM[];
extern const u16 gTrainerPalette_CooltrainerM[];
extern const u16 gTrainerPalette_CooltrainerF[];
extern const u16 gTrainerPalette_EliteFourLorelei[];
extern const u16 gTrainerPalette_EliteFourBruno[];
extern const u16 gTrainerPalette_EliteFourAgatha[];
extern const u16 gTrainerPalette_EliteFourLance[];
extern const u16 gTrainerPalette_LeaderBrock[];
extern const u16 gTrainerPalette_LeaderMisty[];
extern const u16 gTrainerPalette_LeaderLtSurge[];
extern const u16 gTrainerPalette_LeaderErika[];
extern const u16 gTrainerPalette_LeaderKoga[];
extern const u16 gTrainerPalette_LeaderBlaine[];
extern const u16 gTrainerPalette_LeaderSabrina[];
extern const u16 gTrainerPalette_Gentleman[];
extern const u16 gTrainerPalette_RivalLate[];
extern const u16 gTrainerPalette_ChampionRival[];
extern const u16 gTrainerPalette_Channeler[];
extern const u16 gTrainerPalette_Twins[];
extern const u16 gTrainerPalette_CoolCouple[];
...
extern const u16 gTrainerPalette_ProfessorOak[];
extern const u16 gTrainerPalette_RSBrendan2[];
extern const u16 gTrainerPalette_RSMay2[];
extern const u16 gTrainerPalette_Red[];
extern const u16 gTrainerPalette_Leaf[];
extern const u16 gTrainerPalette_RocketGruntF[];
extern const u16 gTrainerPalette_PsychicF[];
extern const u16 gTrainerPalette_CrushGirl[];
extern const u16 gTrainerPalette_TuberF[];
extern const u16 gTrainerPalette_PokemonBreeder[];
...
// fame_checker
extern const u16 gFameCheckerBgPals[];
...
extern const u16 gTeachyTv_Pal[];
...
extern const u16 gBattleAnimSpritePal_SafariBait[];
...
extern const u16 gBerryPouchBgPals[];
extern const u16 gBerryPouchBgPal0FemaleOverride[];
extern const u16 gBerryPouchSpritePalette[];
extern const u32 gBerryPouchBg1Tilemap[];
...
extern const u16 gFile_graphics_misc_confetti_palette[];
...
extern const u16 gBuyMenuFrame_Pal[];
...
extern const u16 gEasyChatWindow_Pal[];
