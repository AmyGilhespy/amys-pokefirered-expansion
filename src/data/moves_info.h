...
#define MOVE_AMY_UNUSED(m) [m] = \
    ...
    [MOVE_MAIL_SCRIPT] =
    {
        .name = COMPOUND_STRING("Mail Script"),
        .description = COMPOUND_STRING(
            "Executes held\nmail script."),
        .effect = EFFECT_MAIL_SCRIPT,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 1, // Same as SKETCH
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_Empty, // For testing, I recommend using: gBattleAnimMove_Present; For production: gBattleAnimMove_Empty
        .validApprenticeMove = TRUE,
    },

    [MOVE_MAIL_CALL] =
    {
        .name = COMPOUND_STRING("Mail Call"),
        .description = COMPOUND_STRING(
            "Executes held\nmail move."),
        .effect = EFFECT_MAIL_CALL,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 20,
