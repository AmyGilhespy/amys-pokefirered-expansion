...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_STEEL_SOUL] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_PRANKSTER, ABILITY_IMPOSTER },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Steel Soul"),
        .cryId = CRY_GENGAR,
        .natDexNum = NATIONAL_DEX_NONE,
        ...
        .trainerScale = 302,
        .trainerOffset = 2,
        .frontPic = gMonFrontPic_SteelSoul,
        ...
        .palette = gMonPalette_SteelSoul,
        .shinyPalette = gMonShinyPalette_SteelSoul,
        .iconSprite = gMonIcon_SteelSoul,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_METEON] =
    {
        ...
        .abilities = { ABILITY_DROUGHT, ABILITY_ORICHALCUM_PULSE, ABILITY_DESOLATE_LAND },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Meteon"),
        .cryId = CRY_MINIOR,
        .natDexNum = NATIONAL_DEX_NONE,
    ...
    [SPECIES_RAIN_PLACEHOLDER] =
    {
        ...
        .backPicFemale = gMonBackPic_Ditto,
        .backPicSizeFemale = MON_COORDS_SIZE(64, 64),
        .paletteFemale = gMonPalette_Ditto,
        .shinyPaletteFemale = gMonShinyPalette_Ditto,
        .iconSpriteFemale = gMonIcon_Ditto,
    ...
    [SPECIES_BROCK] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Brock,
        .shinyPalette = gMonShinyPalette_Brock,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_MISTY] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Misty,
        .shinyPalette = gMonShinyPalette_Misty,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_SABRINA] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Sabrina,
        .shinyPalette = gMonShinyPalette_Sabrina,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_BLAINE] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Blaine,
        .shinyPalette = gMonShinyPalette_Blaine,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_LORELEI] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Lorelei,
        .shinyPalette = gMonShinyPalette_Lorelei,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_BRUNO] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Bruno,
        .shinyPalette = gMonShinyPalette_Bruno,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_AGATHA] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Agatha,
        .shinyPalette = gMonShinyPalette_Agatha,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_LANCE] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Lance,
        .shinyPalette = gMonShinyPalette_Lance,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_MOM] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Mom,
        .shinyPalette = gMonShinyPalette_Mom,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_LILITH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_KLUTZ, ABILITY_KLUTZ, ABILITY_KLUTZ },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_MOLLY] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Molly,
        .shinyPalette = gMonShinyPalette_Molly,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_NATALIE] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Natalie,
        .shinyPalette = gMonShinyPalette_Natalie,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_OLIVIA] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Olivia,
        .shinyPalette = gMonShinyPalette_Olivia,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
    ...
    [SPECIES_AMY] =
    {
        ...
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Amy,
        .shinyPalette = gMonShinyPalette_Amy,
        .iconSprite = gMonIcon_QuestionMark,
        .iconPalIndex = 0,
        FOOTPRINT(QuestionMark)
        .levelUpLearnset = sNoneLevelUpLearnset,
