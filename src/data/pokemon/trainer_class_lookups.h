const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_LITTLE_GIRL]            = TRAINER_PIC_LITTLE_GIRL_1A,
    [FACILITY_CLASS_ULTIMATE_CUTIE]         = TRAINER_PIC_LITTLE_GIRL_2B,
    [FACILITY_CLASS_ROM_HACKER]             = TRAINER_PIC_ROM_HACKER,
    ...
    [FACILITY_CLASS_PSYDUCK]                = TRAINER_PIC_PSYDUCK,
#ifdef BUGFIX
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_ULTIMATE_CUTIE]         = TRAINER_CLASS_ULTIMATE_CUTIE,
    [FACILITY_CLASS_ROM_HACKER]             = TRAINER_CLASS_ROM_HACKER,
