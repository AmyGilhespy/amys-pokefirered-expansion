...
// Poké Balls
    ...
    [ITEM_SPORT_BALL] =
    {
        ...
        .price = 500 /*(I_PRICE < GEN_3 || I_PRICE >= GEN_9) ? 0 : 300*/,
        .description = COMPOUND_STRING(
            "A special Ball "
            "used in the Bug-"
            "\nCatching Contest."),
...
// Medicine
    ...
    [ITEM_REVIVE] =
    {
        ...
        .sortType = ITEM_TYPE_HEALTH_RECOVERY,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUseInNuzlockeRevivalMedicine,
    ...
    [ITEM_SACRED_ASH] =
    {
        ...
        .sortType = ITEM_TYPE_HEALTH_RECOVERY,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUseInNuzlockeSacredAsh,
...
// Ability Modifiers
    ...
    [ITEM_ABILITY_CAPSULE] =
    {
        ...
        .price = 1000 /*(I_PRICE < GEN_7) ? 1000 : ((I_PRICE < GEN_9) ? 10000 : 100000)*/,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Switches a Poké-"
            "mon's ability."),
    ...
    [ITEM_ABILITY_PATCH] =
    {
        ...
        .price = 2500 /*(I_PRICE >= GEN_9) ? 250000 : 20*/,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Turns the ability "
            "of a Pokémon\ninto "
...
// Mints
    ...
    [ITEM_LONELY_MINT] =
    {
        ...
        .price = 500/*(I_PRICE >= GEN_9) ? 20000 : 20*/,
        .description = COMPOUND_STRING(
            "Can be smelled. It "
            "ups Attack,\nbut "
            "reduces Defense."),
...
// Evolution Items
    ...
    [ITEM_GALARICA_CUFF] =
    {
        ...
        .price = 500 /*(I_PRICE >= GEN_9) ? 3000 : 6000*/,
        .description = COMPOUND_STRING(
            "A cuff from Galar "
            "that makes\ncertain "
            "Pokémon evolve."),
    ...
    [ITEM_DRAGON_SCALE] =
    {
        ...
        .price = 500 /*(I_PRICE >= GEN_7) ? 2000 * TREASURE_FACTOR : 2100*/,
    ...
    [ITEM_PRISM_SCALE] =
    {
        ...
        .price = 500 /*(I_PRICE >= GEN_9) ? 3000 : ((I_PRICE >= GEN_7) ? 2000 : 500)*/,
        .description = COMPOUND_STRING(
            "A mysterious scale "
            "that evolves a\n"
            "certain Pokémon."),
    ...
    [ITEM_OVAL_STONE] =
    {
        ...
        .price = 500 /*(I_PRICE >= GEN_7) ? 2000 : 2100*/,
        .description = COMPOUND_STRING(
            "Peculiar stone "
            "that evolves a "
            "\ncertain Pokémon."),
    ...
    [ITEM_EVERSTONE] =
    {
        ...
        .price = 50 /*(I_PRICE >= GEN_7) ? 3000 : 200*/,
...
// Species-specific Held Items
    ...
    [ITEM_DEEP_SEA_SCALE] =
    {
        ...
        .price = 500 /*(I_PRICE >= GEN_7) ? 2000 : 200*/,
...
// Type-boosting Held Items
    ...
    [ITEM_METAL_COAT] =
    {
        ...
        .price = 500 /*(I_PRICE >= GEN_9) ? 3000 : ((I_PRICE >= GEN_7) ? 2000 : 100)*/,
        .holdEffect = HOLD_EFFECT_TYPE_POWER,
        .holdEffectParam = TYPE_BOOST_PARAM,
        .description = COMPOUND_STRING(
            "A hold item that "
...
// Weather Rocks
    ...
    [ITEM_DAMP_ROCK] =
    {
        ...
        .price = 4000 /*(I_PRICE >= GEN_9) ? 8000 : ((I_PRICE >= GEN_7) ? 4000 : 200)*/,
...
// Misc. Held Items
    ...
    [ITEM_KINGS_ROCK] =
    {
        ...
        .price = 500 /*(I_PRICE >= GEN_9) ? 10000 : ((I_PRICE >= GEN_7) ? 5000 : 100)*/,
    ...
    [ITEM_SCOPE_LENS] =
    {
        ...
        .price = 1000 /*(I_PRICE >= GEN_9) ? 15000 : ((I_PRICE >= GEN_7) ? 4000 : 100)*/,
    ...
    [ITEM_SHELL_BELL] =
    {
        ...
        .price = 4000 /*(I_PRICE >= GEN_9) ? 20000 : ((I_PRICE >= GEN_7) ? 4000 : 200)*/,
    ...
    [ITEM_WIDE_LENS] =
    {
        ...
        .price = 1000 /*(I_PRICE >= GEN_9) ? 20000 : ((I_PRICE >= GEN_7) ? 4000 : 200)*/,
    ...
    [ITEM_EXPERT_BELT] =
    {
        ...
        .price = 4000 /*(I_PRICE >= GEN_9) ? 30000 : ((I_PRICE >= GEN_7) ? 4000 : 200)*/,
    ...
    [ITEM_FOCUS_SASH] =
    {
        ...
        .price = 4000 /*(I_PRICE >= GEN_9) ? 50000 : ((I_PRICE >= GEN_7) ? 4000 : 200)*/,
        .holdEffect = HOLD_EFFECT_FOCUS_SASH,
        .description = COMPOUND_STRING(
            "If the holder has "
            "full HP, it\nendures "
    ...
    [ITEM_ZOOM_LENS] =
    {
        ...
        .price = 1000 /*(I_PRICE >= GEN_9) ? 10000 : ((I_PRICE >= GEN_7) ? 4000 : 200)*/,
    ...
    [ITEM_BLACK_SLUDGE] =
    {
        ...
        .price = 4000 /*(I_PRICE >= GEN_9) ? 10000 : ((I_PRICE >= GEN_7) ? 4000 : 200)*/,
    ...
    [ITEM_RAZOR_CLAW] =
    {
        ...
        .price = 500 /*(I_PRICE >= GEN_9) ? 15000 : ((I_PRICE >= GEN_7) ? 5000 : 2100)*/,
        .holdEffect = HOLD_EFFECT_SCOPE_LENS,
        .description = COMPOUND_STRING(
            "A hooked claw that "
            "ups the\nholder's "
    ...
    [ITEM_RED_CARD] =
    {
        ...
        .price = 4000/*(I_PRICE >= GEN_9) ? 3000 : ((I_PRICE >= GEN_7) ? 4000 : 200)*/,
    ...
    [ITEM_TERRAIN_EXTENDER] =
    {
        ...
        .price = 4000 /*(I_PRICE >= GEN_9) ? 15000 : 4000*/,
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_SUBSTITUTE_S] =
    {
        ...
        .price = 4000,
        .description = COMPOUND_STRING(
            "Substitute S. Creates a decoy\nusing 1/8 of your max HP."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_SUBSTITUTE] =
    {
        ...
        .price = 4000,
        .description = COMPOUND_STRING(
            "Substitute. Creates a decoy\nusing 1/4 of your max HP."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_SUBSTITUTE_L] =
    {
        ...
        .price = 4000,
        .description = COMPOUND_STRING(
            "Substitute L. Creates a decoy\nusing 1/2 of your max HP."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_SUBSTITUTE_XL] =
    {
        ...
        .price = 4000,
        .description = COMPOUND_STRING(
            "Substitute XL. Creates a decoy\nusing 3/4 of your max HP."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_OMEGA_BEAM] =
    {
        ...
        .price = 4000,
        .description = COMPOUND_STRING(
            "Omega Beam. Priority +1.\nAlways crits. Must recharge."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_GLITZY_GLOW] =
    {
        ...
        .price = 10000,
        .description = COMPOUND_STRING(
            "Glitzy Glow. Sets up light screen."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_ABSOLUTE_ZERO] =
    {
        ...
        .price = 5000,
        .description = COMPOUND_STRING(
            "Absolute Zero. High chance to\nfreeze. 100% if snowing."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_DRAGON_RAGE] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "Dragon Rage. Always deals exactly\n40 HP of damage."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_SHED_TAIL] =
    {
        ...
        .price = 4000,
        .description = COMPOUND_STRING(
            "Shed Tail. Uses 1/2 of max HP to\ncreate a decoy. Switches out."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_TOXIC_SPIKES] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "SINGLE USE. Toxic Spikes.\nCause poison to foe switching in."),
        .importance = 0,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_RAPID_SPIN] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "SINGLE USE. Rapid Spin.\nClears hazards and raises speed."),
        .importance = 0,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_TM_PHOENIX_CALL] =
    {
        .name = ITEM_NAME("TR100"),
        .price = 100000,
        .description = COMPOUND_STRING(
            "SINGLE USE. Phoenix Call.\nResurrects the dead."),
        .importance = 0,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
    ...
    [ITEM_HM_DIVE] =
    {
        ...
        .price = 0,
        .description = COMPOUND_STRING(
            "Dives underwater the\n1st turn, then attacks\nnext turn."),
        .importance = 1,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = NULL,
...
// GEN 9 ITEMS
    ...
    {
        .name = ITEM_NAME("Piss"),
        .pluralName = ITEM_PLURAL_NAME("Piss"),
