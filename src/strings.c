...
const u8 gText_TmOmegaBeam_4000Coins[]    = _("TM13{FONT_SMALL} Omega Beam{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_TmOmegaStrike_4000Coins[]  = _("TM13{FONT_SMALL} Omega Strike{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_TmOblivionBeam_4000Coins[] = _("TM13{FONT_SMALL} Oblivion Beam{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_TmUltimaStrike_4000Coins[] = _("TM13{FONT_SMALL} Ultima Strike{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_TmHellfire_4000Coins[]     = _("TM13{FONT_SMALL} Hellfire{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_TmAbsoluteZero_4000Coins[] = _("TM13{FONT_SMALL} Absolute Zero{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_TmRailgun_4000Coins[]      = _("TM13{FONT_SMALL} Railgun{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_Tm13_4000Coins[]           = _("TM13{FONT_SMALL} Ice Beam{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_Tm23_3500Coins[]           = _("TM23{FONT_SMALL} Iron Tail{CLEAR_TO 0x5c}3,500 COINS");
const u8 gText_Tm24_4000Coins[]           = _("TM24{FONT_SMALL} Thunderbolt{CLEAR_TO 0x5c}4,000 COINS");
const u8 gText_Tm30_4500Coins[]           = _("TM30{FONT_SMALL} Shadow Ball{CLEAR_TO 0x5c}4,500 COINS");
const u8 gText_Tm35_4000Coins[]           = _("TM35{FONT_SMALL} Flamethrower{CLEAR_TO 0x5c}4,000 COINS");
...
const u8 gText_Unown_100Coins[] = _("UNOWN{CLEAR_TO 0x4B}{FONT_SMALL} 100 COINS");
