...
const u8 gText_GameModeInfo[] = _("GAME MODE INFO");
...
const u8 gText_Limited[]    = _("LIMITED");
const u8 gText_Nuzlocke[]   = _("NUZLOCKE");
const u8 gText_EscapeRoom[] = _("ESC ROOM");
const u8 gText_Invalid[]    = _("INVALID");
...
const u8 gText_TeraTypeChanged[] = _("{STR_VAR_1}'s tera type changed to {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ItemStuckCouldNotRemoveItem[] = _("The {STR_VAR_1} appears to be stuck!\nThe POKéMON's item could not be removed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnBaseVar2StatIncreased[] = _("{STR_VAR_1}'s {STR_VAR_2}\nstat was changed.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnFriendshipChanged[] = _("{STR_VAR_1}'s friendship\nstat was changed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TmOmegaBeam_4000Coins[]    = _("TM55{FONT_SMALL} Omega Beam{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_TmOmegaStrike_4000Coins[]  = _("TM56{FONT_SMALL} Omega Strike{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_TmOblivionBeam_4000Coins[] = _("TM57{FONT_SMALL} Oblivion Beam{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_TmUltimaStrike_4000Coins[] = _("TM58{FONT_SMALL} Ultima Strike{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_TmHellfire_4000Coins[]     = _("TM66{FONT_SMALL} Hellfire{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_TmAbsoluteZero_4000Coins[] = _("TM67{FONT_SMALL} Absolute Zero{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_TmRailgun_4000Coins[]      = _("TM68{FONT_SMALL} Railgun{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_Tm13_4000Coins[]           = _("TM13{FONT_SMALL} Ice Beam{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_Tm23_3500Coins[]           = _("TM23{FONT_SMALL} Iron Tail{CLEAR_TO 0x5e}3,500 COINS");
const u8 gText_Tm24_4000Coins[]           = _("TM24{FONT_SMALL} Thunderbolt{CLEAR_TO 0x5e}4,000 COINS");
const u8 gText_Tm30_4500Coins[]           = _("TM30{FONT_SMALL} Shadow Ball{CLEAR_TO 0x5e}4,500 COINS");
const u8 gText_Tm35_4000Coins[]           = _("TM35{FONT_SMALL} Flamethrower{CLEAR_TO 0x5e}4,000 COINS");
...
const u8 gText_Unown_100Coins[] = _("UNOWN{CLEAR_TO 0x55}{FONT_SMALL} 100 COINS");
...
const u8 gText_Mimikyu_9999Coins[] = _("MIMIKYU{CLEAR_TO 0x4B}{FONT_SMALL} 9,999 COINS");
...
const u8 gText_ToxicOrb_3500Coins[] = _("TOXIC ORB{CLEAR_TO 0x50}{FONT_SMALL}3,500 COINS");
const u8 gText_ChoiceBand_4000Coins[] = _("CHOICE BAND{CLEAR_TO 0x50}{FONT_SMALL}4,000 COINS");
const u8 gText_ChoiceSpecs_4000Coins[] = _("CHOICE SPECS{CLEAR_TO 0x50}{FONT_SMALL}4,000 COINS");
const u8 gText_ChoiceScarf_4000Coins[] = _("CHOICE SCARF{CLEAR_TO 0x50}{FONT_SMALL}4,000 COINS");
const u8 gText_AssaultVest_4000Coins[] = _("ASSAULT VEST{CLEAR_TO 0x50}{FONT_SMALL}4,000 COINS");
const u8 gText_LifeOrb_6500Coins[] = _("LIFE ORB{CLEAR_TO 0x50}{FONT_SMALL}6,500 COINS");
const u8 gText_Leftovers_9999Coins[] = _("LEFTOVERS{CLEAR_TO 0x50}{FONT_SMALL}9,999 COINS");
...
const u8 gText_GameMode[] = _("GAME MODE");
