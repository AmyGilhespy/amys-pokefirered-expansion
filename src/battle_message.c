...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_ATTACKERDIED]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} died!\p"),
    [STRINGID_TARGETDIED]                           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} died!\p"),
    [STRINGID_ATTACKERRANAWAY]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} surrendered!\p"),
    [STRINGID_TARGETRANAWAY]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} surrendered!\p"),
    ...
    [STRINGID_ITEMMADEITRAIN]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} made it rain!"), //not in gen 5+, ability popup
    ...
    [STRINGID_ITEMSXINTENSIFIEDSUN]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_LAST_ITEM} intensified the sun's rays!"), //not in gen 5+, ability popup
    ...
    [STRINGID_ITEMPKMNSWILLPERISHIN9TURNS]          = COMPOUND_STRING("Pokémon will perish in nine turns!"),
    ...
    [STRINGID_POSTRESURRECTION]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s allies came back to life!"),
};
